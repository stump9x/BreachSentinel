"""
Core CTI domain models for BreachSentinel.
...
class Threat(TimeStampedModel):
    ...
    summary_vi = models.TextField(blank=True, default="")
    summary_vi_status = models.CharField(
        max_length=16,
        choices=TitleViStatus.choices,
        default=TitleViStatus.PENDING,
        db_index=True,
    )
    summary_vi_provider = models.CharField(max_length=64, blank=True, default="")
    summary_vi_translated_at = models.DateTimeField(null=True, blank=True)
    summary_hash = models.CharField(max_length=64, blank=True, default="", db_index=True)
    summary_source_language = models.CharField(max_length=16, blank=True, default="")
    summary_vi_attempts = models.PositiveSmallIntegerField(default=0)
