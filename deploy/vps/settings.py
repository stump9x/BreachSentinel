...
# Extra keys (comma / newline / semicolon) — share the NewsCrawler pool for rotation.
GROQ_API_KEYS = env("GROQ_API_KEYS", default="")
GROQ_MODEL = env("GROQ_MODEL", default="llama-3.3-70b-versatile")
GROQ_TIMEOUT_SEC = env.float("GROQ_TIMEOUT_SEC", default=12)
GROQ_KEY_COOLDOWN_SEC = env.float("GROQ_KEY_COOLDOWN_SEC", default=75)
GROQ_MAX_KEY_ATTEMPTS = env.int("GROQ_MAX_KEY_ATTEMPTS", default=6)
GROQ_CIRCUIT_TTL_SEC = env.int("GROQ_CIRCUIT_TTL_SEC", default=90)
GROQ_FAIL_TRIP_THRESHOLD = env.int("GROQ_FAIL_TRIP_THRESHOLD", default=2)
...
# After a Google 429/captcha, skip Google for this many seconds and use Ollama.
GOOGLE_TRANSLATE_CIRCUIT_SEC = env.float("GOOGLE_TRANSLATE_CIRCUIT_SEC", default=120)
# Small delay after each successful Google call to reduce datacenter 429 bursts.
GOOGLE_TRANSLATE_PACING_SEC = env.float("GOOGLE_TRANSLATE_PACING_SEC", default=0.15)
...
# Vietnam-related Wire items: longer retention / ingest window (1 month).
